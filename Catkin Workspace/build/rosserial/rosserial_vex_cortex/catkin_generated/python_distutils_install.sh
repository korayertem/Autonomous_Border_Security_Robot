...
echo_and_run cd "/home/mstbc/Desktop/mstbc/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mstbc/Desktop/mstbc/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/mstbc/Desktop/mstbc/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
